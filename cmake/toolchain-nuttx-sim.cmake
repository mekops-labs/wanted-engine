...
#
# The sim runs on the host, so no cross-compiler is set here — the host
# gcc/clang is used. This file only selects the NuttX platform sources and
# routes WAMR to its NuttX platform layer.
#
# Usage: cmake -B build-nuttx-sim
# -DCMAKE_TOOLCHAIN_FILE=cmake/toolchain-nuttx-sim.cmake
#
...
set(WAMR_BUILD_PLATFORM
    "nuttx"
    CACHE STRING "WAMR platform" FORCE)
