...
# OPENWRT_SYSROOT (SDK target-* dir), OPENWRT_ARCH (aarch64|mips). See
...
if(NOT _owrt_toolchain
   OR NOT _owrt_cross
   OR NOT _owrt_sysroot
   OR NOT _owrt_arch)
    message(
        FATAL_ERROR
...
# FindOpenSSL's static-lib search falls back to it and otherwise leaks the build
# container's own host-arch openssl.pc. Restrict it to the sysroot.
...
if(_owrt_arch STREQUAL "mips")
    set(WAMR_BUILD_TARGET
        "MIPS"
        CACHE STRING "WAMR build target" FORCE)
    set(WAMR_BUILD_INVOKE_NATIVE_GENERAL
        1
        CACHE STRING "WAMR portable C trampoline" FORCE)
    # 32-bit MIPS: libcrypto pulls 8-byte atomics from libatomic.
    string(APPEND CMAKE_EXE_LINKER_FLAGS_INIT
           " -L${_owrt_toolchain}/lib -latomic")
endif()
