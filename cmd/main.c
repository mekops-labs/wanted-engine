...
/* Compiled-in default, used when no config file is given — the configured JSON,
 * generated by the build. This is what a NuttX board with no console arguments
 * boots from. */
