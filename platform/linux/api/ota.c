...
/* The Linux host has no A/B bootloader to bind to -- it always reports a
 * single, permanently-confirmed slot 'a' and rejects write attempts, so a
 * wapp granted the ota driver on Linux gets a well-defined -ENOSYS rather
