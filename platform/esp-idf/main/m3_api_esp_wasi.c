...
static inline int convert_clockid(__wasi_clockid_t in) {
    ...
    // case __WASI_CLOCKID_PROCESS_CPUTIME_ID:   return
...
m3ApiRawFunction(m3_wasi_generic_random_get) {
    ...
    defined(__OpenBSD__) || defined(__EMSCRIPTEN__)
        ...
        retlen = SecRandomCopyBytes(kSecRandomDefault, reqlen, buf) < 0
                     ? -1
                     : reqlen;
#else
...
M3Result m3_LinkEspWASI(IM3Module module) {
    ...
    _(SuppressLookupFailure(
        m3_LinkRawFunction(module, "wasi_snapshot_preview1", "fd_seek",
                           "i(iIi*)", &m3_wasi_snapshot_preview1_fd_seek)));
    ...
    for (int i = 0; i < 2; i++) {
        ...
        _(SuppressLookupFailure(m3_LinkRawFunction(
            module, wasi, "fd_close", "i(i)", &m3_wasi_generic_fd_close)));
        _(SuppressLookupFailure(
        ...
        //))); _     (SuppressLookupFailure (m3_LinkRawFunction (module, wasi,
        //"fd_sync",              "i(i)",    ))); _     (SuppressLookupFailure
        //(m3_LinkRawFunction (module, wasi, "fd_tell",              "i(i*)",
        //)));
        _(SuppressLookupFailure(m3_LinkRawFunction(
        ...
        //&m3_wasi_generic_path_filestat_get))); _     (SuppressLookupFailure
        ...
        _(SuppressLookupFailure(
            m3_LinkRawFunction(module, wasi, "path_open", "i(ii*iiIIi*)",
        ...
        //_     (SuppressLookupFailure (m3_LinkRawFunction (module, wasi,
        //"sock_recv",            "i(i*ii**)",        ))); _
        //(SuppressLookupFailure (m3_LinkRawFunction (module, wasi, "sock_send",
        //"i(i*ii*)",         ))); _     (SuppressLookupFailure
        //(m3_LinkRawFunction (module, wasi, "sock_shutdown",        "i(ii)",
        //)));
    }
