...
/* WiFi station node for the unit-test platform. The radio is a hardware
 * capability with no host equivalent, so the node accepts an open and reports
 * operations as unsupported, keeping the `wifi` driver resolvable in the test
 * build. */
